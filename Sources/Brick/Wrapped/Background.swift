...
/// Brick 扩展：背景修饰器
/// Brick extension: Background modifier
@MainActor 
public extension Brick where Wrapped: View {
    ...
    /// 隐藏 TextView 背景 (iOS 16+)
    /// Hide TextView background (iOS 16+)
    /// - Returns: 修改后的 View / Modified View
